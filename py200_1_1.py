...
class Glass:
    def __init__(self, capacity_volume, occupied_volume):
        ...
        if isinstance(occupied_volume, (int, float)):
            #TODO нужно проверить на переполнение водой
...
class GlassAddRemove:
    ...
    def add_water(self, adding_water):
        ...
        # TODO - разобраться здесь. Не работает
        else:
...
print(dir(glass_6_1)) # выводит список build-in методов и аттрибутов и список пользовательских методов и аттрибутов
...
class GlassDir:
    def __init__(self, capacity_volume, occupied_volume):
        ...
        print(self.__dict__)  # распечатает объект, с которым мы будем работать
...
#TODO вывести raise, если от 10 до 50, вместо return
a1 = A(15)
print(dir(a1))
a2 = A(55)
print(dir(a2))
